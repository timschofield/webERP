...
// KL RICARD END: Exclude SPG, as they are maintained in KLUsersSPG.php
...
//		prnMsg(__('User has been authorized to use and update all GL accounts'), 'success' );
	...
	// KL RICARD: Use the function to properly delete the user
...
if(isset($SelectedUser)) {
	...
	echo '<fieldset>
			<legend>', __('Update webERP User Details'), '</legend>
			<field>
	...
	echo '<fieldset>
			<legend>', __('Create New webERP User (except KL SPG)'), '</legend>
			<field>
