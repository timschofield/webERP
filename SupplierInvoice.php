		...
		if ($_SESSION['SuppTrans']->GLLink_Creditors == 1) {
			...
			*/
			...
			if ($Debug == 1 AND (abs($_SESSION['SuppTrans']->OvAmount / $_SESSION['SuppTrans']->ExRate) - $LocalTotal) > 0.009999) {
				...
				echo '<p>' . __('The total posted to the debit accounts is') . ' ' . $LocalTotal . ' ' . __('but the sum of OvAmount converted at ExRate') . ' = ' . ($_SESSION['SuppTrans']->OvAmount / $_SESSION['SuppTrans']->ExRate);
			}
