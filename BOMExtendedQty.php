...
if (isset($_POST['PrintPDF']) or isset($_POST['View'])) {
	...
	if (DB_error_no() !=0) {
		$Title = __('Quantity Extended BOM Listing') . ' - ' . __('Problem Report');
		include('includes/header.php');
		prnMsg( __('The Quantiy Extended BOM Listing could not be retrieved by the SQL because') . ' '  . DB_error_msg(),'error');
