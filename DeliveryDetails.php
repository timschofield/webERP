...
echo'<field>
	...
	<field>
		<label for="CustRef">' .  _('OpenCart/Marketplace/Other Inv. Number') .':</label>
		<input type="text" size="25"  maxlength="50" name="CustRef" value="' . $_SESSION['Items'.$identifier]->CustRef . '" title="" />
		<fieldhelp>' . _('Enter the OpenCart/Marketplace/Other Inv. Number relevant to this order') . '</fieldhelp>
	</field>
	<field>
