...
echo'<field>
	...
	<field>
		<label for="CustRef">' .  __('OpenCart/Marketplace/Other Inv. Number') .':</label>
		<input type="text" size="25"  maxlength="50" name="CustRef" value="' . $_SESSION['Items'.$identifier]->CustRef . '" title="" />
		<fieldhelp>' . __('Enter the OpenCart/Marketplace/Other Inv. Number relevant to this order') . '</fieldhelp>
	</field>
	<field>
