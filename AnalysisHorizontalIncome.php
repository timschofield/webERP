		...
		<tfoot>
			<tr>
				<td class="text" colspan="6">',// Prints an explanation of signs in absolute and relative variations:
					'<br /><b>', _('Notes'), ':</b><br />',
					_('Absolute variation signs: a positive number indicates a variation that increases the net profit; a negative number indicates a variation that decreases the net profit.'), '<br />',
