...
$Title = _('Balance Sheet for CV. Merta Bali');
	...
	while ($myrow=DB_fetch_array($AccountsResult)) {
		...
		if ($myrow['accountcode'] == $RetainedEarningsAct){
			$SQL = "SELECT SUM(chartdetails.bfwd + chartdetails.actual)
					FROM chartdetails, chartmasterCV, accountgroups
					WHERE chartdetails.accountcode = chartmasterCV.accountcode
						AND chartmasterCV.group_ = accountgroups.groupname
