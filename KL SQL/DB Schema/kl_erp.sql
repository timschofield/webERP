...
CREATE TABLE `pcashdetails` (
  ...
  `notes` text NOT NULL,
  `receipt` text DEFAULT NULL COMMENT 'Not redundant for KL webERP as it stores the receipt code as usual'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `purchorders` (
  ...
  `stat_comment` text NOT NULL DEFAULT '',
...
CREATE TABLE `securityroles` (
  `secroleid` int(11) NOT NULL,
  `secrolename` text NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `woserialnos` (
  ...
  `quantity` double NOT NULL DEFAULT 1,
  `qualitytext` text NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
ALTER TABLE `klkpi`
  ADD UNIQUE KEY `concept+date` (`kpicode`,`date`) USING BTREE,
  ADD UNIQUE KEY `date+concept` (`date`,`kpicode`) USING BTREE;

--
-- Indexes for table `klkpidescriptions`
--
ALTER TABLE `klkpidescriptions`
  ADD UNIQUE KEY `kpicode` (`kpicode`);
