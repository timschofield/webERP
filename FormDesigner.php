...
// BEGIN: Data division --------------------------------------------------------
$PaperSizes = array('A3_Portrait', 'A3_Landscape',
					'A4_Portrait', 'A4_Landscape',
					'A5_Portrait', 'A5_Landscape',
					'A6_Portrait', 'A6_Landscape',
					'Legal_Portrait', 'Legal_Landscape',
					'Letter_Portrait', 'Letter_Landscape'); // Possible paper sizes and orientations.
// END: Data division ----------------------------------------------------------
...
if (empty($_POST['FormName'])) {
	echo '<form action="', htmlspecialchars($_SERVER['PHP_SELF'],ENT_QUOTES,'UTF-8'), '" id="ChooseForm" method="post">
		...
		<table class="selection">
			<tr>
				<th colspan="2">Edit Form Layout</th>
			</tr>
			<tr>
				...
				<td colspan="2">',
					'<div class="centre">',
						'<button name="Submit" type="submit" value="Submit">',
							'<img alt="" src="', $RootPath, '/css/', $Theme, '/images/tick.svg" /> ', _('Submit'),
						'</button>', // "Submit" button.
						'<button onclick="window.location=\'index.php?Application=system\'" type="button">',
							'<img alt="" src="', $RootPath, '/css/', $Theme, '/images/return.svg" /> ', _('Return'),
