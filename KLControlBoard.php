...
*/
	...
	***************************************************************************************/
	...
	if ($KL_SystemAdmin){
		...
		$NumberOfTestExecuted++;
		BalanceAccountControl("111512000",   50000000,  100000000, $periodnow, $db);
		$NumberOfTestExecuted++;
...
*/
		...
		$NumberOfTestExecuted++;
		CategoryItemsNotInShop("TESTKL", "TOKSU", 7, $RootPath, $db);
		$NumberOfTestExecuted++;
		...
		$NumberOfTestExecuted++;
		CategoryItemsNotInShop("STABKL", "TOKSU", 10, $RootPath, $db);
		$NumberOfTestExecuted++;
		...
		$NumberOfTestExecuted++;
		CategoryItemsNotInShop("NOPOKL", "TOKSU", 7, $RootPath, $db);
		$NumberOfTestExecuted++;
		...
		$NumberOfTestExecuted++;
		CategoryItemsNotInShop("TESTBL", "TOKBU", 3, $RootPath, $db);
		$NumberOfTestExecuted++;
		...
		$NumberOfTestExecuted++;
		CategoryItemsNotInShop("STABBL", "TOKBU", 3, $RootPath, $db);
		$NumberOfTestExecuted++;
