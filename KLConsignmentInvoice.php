...
// the page is called.
	...
	if($_POST['CompanyFrom']=="PTADU") {
		...
		echo '<option value="PTBB">' . 'PT BB (temporary until end of stock)' . '</option>';
	} else {
		echo '<option selected="selected" value="PTBB">' . 'PT BB (temporary until end of stock)' . '</option>';
