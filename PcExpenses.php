...
if (!isset($SelectedExpense)) {
	...
	// KL RICARD added 2 fields to SQL and table
...
if (!isset($_GET['delete'])) {
	...
	echo '<field>
			<label for="KLRetentionPPH21">' . __('% Retention PPH21') . ':</label>
	...
	echo '<field>
			<label for="KLRetentionPPH23">' . __('% Retention PPH23') . ':</label>
