...
echo '<tr>
		...
		<td><input type="integer" pattern="[1-9][\d]{0,20}" title="'._('The input must be positive integer').'" placeholder="'._('Integer less than 20 digits').'" name="GLCode" size="21" maxlength="20" value="' .  $_POST['GLCode'] . '" />
