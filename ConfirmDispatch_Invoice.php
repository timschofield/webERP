...
// KL RICARD End of Consignment sales for PTADU MODIFICATIONS
	...
	echo '<field>
			<label for="Consignment">', _('Tracking Number'), ':</label>
			<input type="text" maxlength="20" size="20" name="Consignment" value="', $_POST['Consignment'], '" />
			<fieldhelp>', _('Enter the tracking number from shipper to enable tracking of the delivery in the event of customer proof of delivery issues.'), '</fieldhelp>
		</field>';
