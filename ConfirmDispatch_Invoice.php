...
// KL RICARD End of Consignment sales for PTADU MODIFICATIONS
	...
	echo '<table class="selection">
		...
		<tr>
			...
			<td><input data-type="no-illegal-chars" maxlength="20" name="Consignment" size="20" title="', _('Enter the tracking number from shipper to enable tracking of the delivery in the event of customer proof of delivery issues'), '" type="text" value="', $_POST['Consignment'], '" /></td>
		</tr>
		<tr>
