...
or deletion of the records*/
	...
	while ($MyRow=DB_fetch_row($Result)) {
		...
		echo '<tr class="striped_row">
				...
				<td>', $MyRow[5], '</td>
				<td>', $MyRow[6], '</td>
				<td><a href="', htmlspecialchars($_SERVER['PHP_SELF'],ENT_QUOTES,'UTF-8'), '?SelectedParam=', $MyRow[0], '">' . _('Edit') . '</a></td>
				<td><a href="', htmlspecialchars($_SERVER['PHP_SELF'],ENT_QUOTES,'UTF-8'), '?SelectedParam=', $MyRow[0], '&delete=', $MyRow[0], '">' .  _('Delete')  . '</a></td>
			</tr>';
