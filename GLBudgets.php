...
echo '<form action="' . htmlspecialchars($_SERVER['PHP_SELF']) . '" method="post" name="selectaccount">';
...
// Table Headers
	...
	echo '<form name="form" action="' . htmlspecialchars($_SERVER['PHP_SELF']) . '" method=post>';
	echo '<input type="hidden" name="FormID" value="' . $_SESSION['FormID'] . '" />';
	echo '<br />
