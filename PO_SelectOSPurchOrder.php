...
if (isset($StockItemsResult)) {
	...
	echo '<tr>
			...
			<th class="SortedColumn">' . __('Payment Date') . '</th>
			<th class="SortedColumn">' . __('Shipment Date') . '</th>
			<th class="SortedColumn">' . __('Arrival Date') . '</th>
			<th class="SortedColumn">' . __('Supplier') . '</th>
			' . $BalHead . '
			<th class="SortedColumn">' . __('Currency') . '</th>';

	if (in_array($PricesSecurity, $_SESSION['AllowedPageSecurityTokens']) OR !isset($PricesSecurity)) {
		echo '<th class="ascending">' . __('Order Total') . '</th>';
	}
	// KL RICARD Use custom fields
	echo '<th class="SortedColumn">' . __('# Items') . '</th>';
	echo '	<th class="SortedColumn">' . __('KL Status') . '</th>
