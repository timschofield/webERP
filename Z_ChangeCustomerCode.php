...
/* KL RICARD Connect to archive too, to change the code of already archived customer data*/
...
/*Now check that the new code doesn't already exist */
	...
	/* KL Specific Tables */
	prnMsg(__('Changing KL Consignment records'),'info');
	$SQL = "UPDATE klconsignment SET debtorno='" . $_POST['NewDebtorNo'] . "' WHERE debtorno='" . $_POST['OldDebtorNo'] . "'";
	$ErrMsg = __('The SQL to update KL Consignment records failed');
	$Result = DB_query($SQL, $ErrMsg, '', true);

	prnMsg(__('Changing KL Consignment records in Archive DB'),'info');
	$SQL = "UPDATE klconsignment SET debtorno='" . $_POST['NewDebtorNo'] . "' WHERE debtorno='" . $_POST['OldDebtorNo'] . "'";
	$ErrMsg = __('The SQL to update KL Consignment records in Archive DB failed');
	$Result = DB_query_archive($SQL, $ErrMsg, '', true);
	/* End KL Specific Tables */
