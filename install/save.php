...
/*Klaus Opto advised that timeout issues made it difficult to install even though max_execution_time has been set -
 * Tim thought set_time_limit should also be set - it might be a windows thing - Klaus was using WAMP */
set_time_limit(580);
