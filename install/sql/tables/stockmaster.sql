CREATE TABLE `stockmaster` (
  ...
  `lastcost` decimal(24,8) NOT NULL DEFAULT '0.00000000',
  `materialcost` decimal(24,8) NOT NULL DEFAULT '0.00000000',
  `labourcost` decimal(24,8) NOT NULL DEFAULT '0.00000000',
  `overheadcost` decimal(24,8) NOT NULL DEFAULT '0.00000000',
  ...
  `actualcost` decimal(24,8) GENERATED ALWAYS AS (((`materialcost` + `labourcost`) + `overheadcost`)) STORED,
  PRIMARY KEY (`stockid`),
