...
or deletion of the records*/
	...
	printf('<td class="number">%s</td>
			...
			<td><a href="%sSelectedMovement=%s&amp;delete=1" onclick="return confirm(\'' . _('Are you sure you wish to delete this movement to discount?') . '\');">' . _('Delete') . '</a></td>
			</tr>',
...
if (isset($SelectedMovement)) {
	echo '<div class="centre"><a href="' . htmlspecialchars($_SERVER['PHP_SELF'],ENT_QUOTES,'UTF-8') . '">' . _('Show All Active Movements To Discount') . '</a></div>';
}
