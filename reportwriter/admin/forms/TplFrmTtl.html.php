...
<form name="DBRptLine" method="post" action="ReportCreator.php?action=step6a">
  ...
  <table align="center" border="2" cellspacing="1" cellpadding="1">
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#CCCCCC">
      <td colspan="2"><div align="center">Fields</div></td>
    </tr>
    <tr>
      <td colspan="2"><div align="center"> </div>
          <div align="center"><?php echo RPT_FLDTOTAL; ?></div></td>
    </tr>
    <tr>
      <td>
	    <select name="TotalField"><OPTION Value=""><?php echo RPT_SLCTFIELD; ?>
		<?php echo CreateFieldList($ReportID,$Params['TotalField'],''); ?></select>
	  </td>
      <td><input type="submit" name="todo" value="<?php echo RPT_BTN_ADD; ?>"></td>
    </tr>
    <tr>
      <td><select name="FieldIndex" size="3">
		  <?php if (is_array($Params['Seq'])) foreach ($Params['Seq'] as $key=>$value) {
			echo '<option value="'.$key.'">'.$value.'</option>'; } ?>
          </select></td>
      <td valign="bottom"><input type="submit" name="todo" value="<?php echo RPT_BTN_REMOVE; ?>"></td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#CCCCCC">
    ...
    <tr>
      ...
      <td nowrap><input name="Fill" type="radio" value="2"<?php echo $selected; ?>><?php echo RPT_CUSTCOLOR; ?><br />
		<div align="center">
