...
if(!isset($_POST['PeriodFrom']) OR !isset($_POST['PeriodTo']) OR $_POST['Action']=='New') {
	...
	echo 		'<td><input class="date" id="PeriodFrom" maxlength="10" name="PeriodFrom" required="required" size="11" type="text" value="', $_POST['PeriodFrom'], '" />',
					'<span class="field_help_text">',
						_('Select the beginning of the reporting period'), // If the $_SESSION['ShowFieldHelp'] parameter is not set OR it is TRUE, shows the field help text.
					'</span>',
		 		'</td>
			</tr>',
			// Select period to:
	...
	echo 		'<td><input class="date" id="PeriodTo" maxlength="10" name="PeriodTo" required="required" size="11" type="text" value="', $_POST['PeriodTo'], '" />',
					'<span class="field_help_text">',
						_('Select the end of the reporting period'), // If the $_SESSION['ShowFieldHelp'] parameter is not set OR it is TRUE, shows the field help text.
					'</span>',
		 		'</td>
			</tr>',
			...
			'<tr>',
			 	...
			 	'<td>',
				 	...
				 	'<span class="field_help_text">',
				 		_('Check this box to show sales invoices'), // If the $_SESSION['ShowFieldHelp'] parameter is not set OR it is TRUE, shows the field help text.
			 		'</span>',
		 		'</td>
			</tr>',
		 '</tbody></table>';
