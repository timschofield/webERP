...
if ($_GET['EmailType']=='TrackingConfirmation'){
	...
	UpdateOpenCartOrderStatus($_GET['CustomerOrder'], OPENCART_ORDER_STATUS_SHIPPED, 0, $myrow['shipvia'], $myrow['consignment'], $ReasonChangeStatusId, $db, $db_oc, $oc_tableprefix);
	...
	UpdateOpenCartOrderStatus($_GET['CustomerOrder'], OPENCART_ORDER_STATUS_COMPLETE, 0, "", "", $ReasonChangeStatusId, $db, $db_oc, $oc_tableprefix);
