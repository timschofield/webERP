...
if (isset($_POST['PrintPDF']) or isset($_POST['View'])) {
	...
	if (DB_error_no() != 0) {
		...
		prnMsg(__('An error occurred getting the variances between deliveries and orders'), 'error');
		if ($Debug == 1) {
			prnMsg(__('The SQL used to get the variances between deliveries and orders that failed was') . '<br />' . $SQL, 'error');
		}
