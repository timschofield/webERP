...
if (isset($_SESSION['AccessLevel'])){
	if ($_SESSION['AccessLevel'] == 8){ // webERP System Administration (R)
		$KL_SystemAdmin = true;
	} elseif ($_SESSION['AccessLevel'] == 14){ // Operational Manager (Ike)
	...
	} elseif ($_SESSION['AccessLevel'] == 21){ // Business Development manager (Laia)
		...
		$KL_ITSupport = true;
	} elseif ($_SESSION['AccessLevel'] == 34){ // Sales DIrector (a.k.a Fathus)
	...
	} elseif ($_SESSION['AccessLevel'] == 38){ // Marketing Manager (ex Aisyah)
