...
$pdf->setFont('', 'B');
$pdf->addText($FormDesign->Heading->x, $Page_Height - $FormDesign->Heading->y, $FormDesign->Heading->FontSize, __('Pick List-NOT USED FOR SHIPMENT'));
$pdf->setFont('', '');
$pdf->addText($FormDesign->HeadingLine2->x, $Page_Height - $FormDesign->HeadingLine2->y, $FormDesign->HeadingLine2->FontSize, __('From') . ' ' . $OrdersToPick[$i]['locationname'] . ' ' . __('Warehouse'));
...
$pdf->addText($FormDesign->DeliveryAddress->Caption->x, $Page_Height - $FormDesign->DeliveryAddress->Caption->y, $FormDesign->DeliveryAddress->Caption->FontSize, __('Deliver To') . ':');
...
$pdf->addText($FormDesign->CustomerAddress->Caption->x, $Page_Height - $FormDesign->CustomerAddress->Caption->y, $FormDesign->CustomerAddress->Caption->FontSize, __('Customer') . ':');
...
$pdf->addText($FormDesign->OrderNumberCaption->x, $Page_Height - $FormDesign->OrderNumberCaption->y, $FormDesign->OrderNumberCaption->FontSize, __('Order No') . ':');
...
$pdf->addText($FormDesign->DeliveryDateCaption->x, $Page_Height - $FormDesign->DeliveryDateCaption->y, $FormDesign->DeliveryDateCaption->FontSize, __('Delivery Date') . ':');
...
$pdf->addText($FormDesign->DatePrintedCaption->x, $Page_Height - $FormDesign->DatePrintedCaption->y, $FormDesign->DatePrintedCaption->FontSize, __('Printed') . ': ');
...
$pdf->addText($FormDesign->CustomerCode->x, $Page_Height - $FormDesign->CustomerCode->y, $FormDesign->CustomerCode->FontSize, __('Customer No.') . ' : ' . $OrdersToPick[$i]['debtorno']);
$pdf->addText($FormDesign->ShipperCode->x, $Page_Height - $FormDesign->ShipperCode->y, $FormDesign->ShipperCode->FontSize, __('Shipped by') . ' : ' . $OrdersToPick[$i]['shippername']);
$pdf->addText($FormDesign->PickList->x, $Page_Height - $FormDesign->PickList->y, $FormDesign->PickList->FontSize, __('Pick List') . ' :     ' . str_pad($Count[1], 10, '0', STR_PAD_LEFT));
...
$pdf->addText($FormDesign->PageNumberCaption->x, $Page_Height - $FormDesign->PageNumberCaption->y, $FormDesign->PageNumberCaption->FontSize, __('Page') . ':');
$pdf->addText($FormDesign->PageNumber->x, $Page_Height - $FormDesign->PageNumber->y, $FormDesign->PageNumber->FontSize, $PageNumber);
$pdf->setFont('', 'B');
$LeftOvers = $pdf->addTextWrap($FormDesign->Headings->Column1->x, $Page_Height - $FormDesign->Headings->Column1->y, $FormDesign->Headings->Column1->Length, $FormDesign->Headings->Column1->FontSize, __('Item Code'), 'left');
$LeftOvers = $pdf->addTextWrap($FormDesign->Headings->Column2->x, $Page_Height - $FormDesign->Headings->Column2->y, $FormDesign->Headings->Column2->Length, $FormDesign->Headings->Column2->FontSize, __('Item Description'), 'left');
$LeftOvers = $pdf->addTextWrap($FormDesign->Headings->Column3->x, $Page_Height - $FormDesign->Headings->Column3->y, $FormDesign->Headings->Column3->Length, $FormDesign->Headings->Column3->FontSize, __('Bin Location'), 'right');
$LeftOvers = $pdf->addTextWrap($FormDesign->Headings->Column4->x, $Page_Height - $FormDesign->Headings->Column4->y, $FormDesign->Headings->Column4->Length, $FormDesign->Headings->Column4->FontSize, __('Open Quantity'), 'right');
$LeftOvers = $pdf->addTextWrap($FormDesign->Headings->Column5->x, $Page_Height - $FormDesign->Headings->Column5->y, $FormDesign->Headings->Column5->Length, $FormDesign->Headings->Column5->FontSize, __('Available'), 'right');
$LeftOvers = $pdf->addTextWrap($FormDesign->Headings->Column6->x, $Page_Height - $FormDesign->Headings->Column6->y, $FormDesign->Headings->Column6->Length, $FormDesign->Headings->Column6->FontSize, __('Actual Picked'), 'right');
$pdf->setFont('', '');
...
$pdf->RoundRectangle($FormDesign->CustomerAddressBox->x, $Page_Height - $FormDesign->CustomerAddressBox->y, $FormDesign->CustomerAddressBox->width, $FormDesign->CustomerAddressBox->height, $FormDesign->CustomerAddressBox->radius, $FormDesign->CustomerAddressBox->radius); // Function RoundRectangle from includes/class.cpdf.php
$pdf->RoundRectangle($FormDesign->DataBox->x, $Page_Height - $FormDesign->DataBox->y, $FormDesign->DataBox->width, $FormDesign->DataBox->height, $FormDesign->DataBox->radius, $FormDesign->DataBox->radius); // Function RoundRectangle from includes/class.cpdf.php
...
$pdf->setFont('', 'B');
$pdf->addText($FormDesign->DeliveryAddressBox->x, $Page_Height - $FormDesign->ColumnLine5->endy, $FormDesign->Heading->FontSize, __('NOT A PACKING LIST.      DO NOT USE FOR SHIPMENT.      DRIVER DO NOT ACCEPT'));
$pdf->setFont('', '');
