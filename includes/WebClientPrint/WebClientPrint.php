...
if(strpos($_SERVER['HTTP_HOST'],"bumibiru")){
...
}else if(strpos($_SERVER['HTTP_HOST'],"adu")){
	if (strpos($_SERVER['PHP_SELF'],"TEST")){
	...
	if (strpos($_SERVER['PHP_SELF'],"TEST")){
		$CachePath = '/home4/kurakura/public_html/mertabali.com/TEST/weberp/includes/WebClientPrint/wcpcache/';
	}else{
		$CachePath = '/home4/kurakura/public_html/mertabali.com/weberp/includes/WebClientPrint/wcpcache/';
	}
}
