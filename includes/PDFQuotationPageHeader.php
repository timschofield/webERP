...
$XPos = 46;
$YPos = 566;
PrintDeliverTo($pdf,$MyRow,__('Delivery To'),$XPos,$YPos);


// Prints 'Quotation For' info:
$YPos -= 82;
PrintCompanyTo($pdf,$MyRow,__('Quotation For'),$XPos,$YPos);
...
$XPos = 40;
$YPos -= 37;
$LeftOvers = $pdf->addTextWrap($Left_Margin, $YPos,103, $FontSize, __('Item Code'));
...
$LeftOvers = $pdf->addTextWrap(145, $YPos,250, $FontSize, __('Item Description'));
$LeftOvers = $pdf->addTextWrap(420, $YPos, 85, $FontSize, __('Quantity'),'right');
$LeftOvers = $pdf->addTextWrap(485, $YPos, 85, $FontSize, __('Price'),'right');
$LeftOvers = $pdf->addTextWrap(535, $YPos, 85, $FontSize, __('Discount'),'right');
$LeftOvers = $pdf->addTextWrap(615, $YPos, 55, $FontSize, __('Tax Class'),'right');
...
$LeftOvers = $pdf->addTextWrap(665, $YPos, 70, $FontSize, __('Tax Amount'),'right');
