...
$LeftOvers = $pdf->addTextWrap($Xpos,$YPos,320 - $Left_Margin,$FontSize,__('Component Part/Description'),'centre');
$LeftOvers = $pdf->addTextWrap(300,$YPos,60,$FontSize,__('Effective After'),'centre');
$LeftOvers = $pdf->addTextWrap(348,$YPos,60,$FontSize,__('Effective To'),'centre');
$LeftOvers = $pdf->addTextWrap(403,$YPos,40,$FontSize,__('Locn'),'centre');
$LeftOvers = $pdf->addTextWrap(435,$YPos,40,$FontSize,__('Wrk Cntr'),'centre');
$LeftOvers = $pdf->addTextWrap(500,$YPos,60,$FontSize,__('Quantity'),'centre');
