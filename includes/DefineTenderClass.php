...
Class Tender {
	...
	function EmailSuppliers() {
		...
		$FromEmail = $_SESSION['PurchasingManagerEmail'];
		
		foreach ($this->Suppliers as $Supplier) {
			// Send email to supplier with CC to Purchasing Manager
			$Result = SendEmailFromWebERP($FromEmail, 
								array($Supplier->EmailAddress, $FromEmail), 
								$Subject, 
								$EmailText, 
