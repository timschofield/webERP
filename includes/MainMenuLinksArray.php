...
$MenuItems['GL']['Reports']['Caption'] = array( _('Bank Account Reconciliation Statement'),
												...
												_('Balance Sheet for PT. Sungai Mutiara Hitam'),
												_('Balance Sheet for PT. Bumi Biru'),
												_('Balance Sheet for Retail Partner POIK'),
												_('Balance Sheet for Retail Partner POPI'),
												...
												_('GL Transactions for PT. Sungai Mutiara Hitam (Excel File)'),
												_('GL Transactions for PT. Bumi Biru (Excel File)'),
												_('GL Transactions for Retail Partner POIK (Excel File)'),
												_('GL Transactions for Retail Partner POPI (Excel File)'),
...
$MenuItems['GL']['Reports']['URL'] = array(	'/BankReconciliation.php',
											...
											'/KLGLBalanceSheetSMH.php',
											'/KLGLBalanceSheetPT.php',
											'/KLGLBalanceSheetIK.php',
											'/KLGLBalanceSheetPI.php',
											'/GLProfit_Loss.php',
											...
											'/KLExcelGLTransactionsPajakSMH.php',
											'/KLExcelGLTransactionsPajakPT.php',
											'/KLExcelGLTransactionsPajakIK.php',
											'/KLExcelGLTransactionsPajakPI.php',
