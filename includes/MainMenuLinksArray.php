...
$MenuItems['orders']['Maintenance']['Caption'] = array( _('Create Contract'),
														...
														_('Sendinblue: Export KL Online Customers'),
...
$MenuItems['stock']['Reports']['Caption'] = array(	_('Serial Item Research Tool'),
													...
													_('Stock Status at KL Shops for SPG'),
													_('Stock Status at KL Shops for Manager'),
...
$MenuItems['stock']['Maintenance']['Caption'] = array(	_('Add A New Item'),
														...
														_('KL Move To Discount Process - Step 01'),
														_('KL Move To Discount Process - Step 02'),
														_('KL Move To Outlet Process - Step 01'),
														_('KL Move To Outlet Process - Step 02'),
...
$MenuItems['stock']['Maintenance']['URL'] = array(	'/Stocks.php',
													...
													'/KLMoveToDiscountStep01.php',
													'/KLMoveToDiscountStep02.php',
													'/KLMoveToOutletStep01.php',
													'/KLMoveToOutletStep02.php',
...
$MenuItems['GL']['Reports']['Caption'] = array(	_('Trial Balance'),
												...
												_('Profit and Loss Statement for Kapal-Laut'),
												_('Profit and Loss Statement for CV. Merta Bali'),
...
$MenuItems['GL']['Reports']['URL'] = array(	'/GLTrialBalance.php',
											...
											'/GLProfit_Loss.php',
											'/KLGLProfit_LossM.php',
											'/KLGLProfit_LossCV.php',
