...
$MenuItems['GL']['Reports']['Caption'] = array( _('Bank Account Reconciliation Statement'),
												...
												_('Balance Sheet for Retail Partner IK'),
												...
												_('Profit and Loss Statement for Retail Partner IK'),
												...
												_('GL Transactions for Retail Partner IK (Excel File)'),
...
$MenuItems['GL']['Maintenance']['Caption'] = array(	_('Account Sections'),
													...
													_('GL Accounts for Retail Partner IK'),
													_('GL Budgets'),
													_('GL Tags'),
