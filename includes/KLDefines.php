...
define("ZONES_OF_SHOPS",   "('KUTA','SANUR','SEMINYAK','UBUD')"); 

define("LIST_ALL_SHOPS",           "('TOK66','TOKSA','TOKKS','TOKSE','TOKUB','TOKMF','TOKPU','TOKSU','TOKOB','TOKSS','TOKPA','TOKKA','TOKMU','TOKPS','TOKAR','TOKSB','TOKPB','TOKBU','TOKM2','TOKU2','TOKU3','TOKO2')"); // NOT includes the shop online
define("LIST_SHOPS_KAPAL_LAUT",    "('TOK66','TOKSA','TOKKS','TOKSE','TOKMF','TOKPU','TOKOB','TOKSS','TOKPA','TOKKA','TOKM2','TOKSU','TOKU2')"); // NOT includes the shop online
define("LIST_SHOPS_OUTLET",        "('TOKUB','TOKAR')"); 
define("LIST_SHOPS_BLINK",         "('TOKMU','TOKPS','TOKSB','TOKPB','TOKBU','TOKU3','TOKO2')");

define("LIST_ONLINE_SHOPS", "('TOKWS')");

define("LIST_GUDANG_FOR_PACKAGING","('PACKA')");

define("LIST_LOCATIONS_SPG_STOCK_STATUS", "('KANTO','TOK66','TOKSA','TOKKS','TOKSE','TOKUB','TOKMF','TOKOB','TOKPU','TOKSU','TOKSS','TOKPA','TOKKA','TOKMU','TOKPS','TOKAR','TOKSB','TOKPB','TOKBU','TOKM2','TOKU2','TOKU3','TOKO2')"); 
...
define("PERCENTAGE_COMPENSATION_HPP_PT", 135.0); // % of HPP to be assigned to PT sales. 100 means NO compensation.
...
define("LOCATIONS_WITH_STOCK_FOR_ONLINE_SHOP", 'KANTO,TOK66,TOKSA,TOKSS,TOKOB,TOKKS,TOKUB,TOKMF,TOKSE,TOKSU,TOKPU,TOKPA,TOKKA,TOKMU,TOKPS,TOKAR,TOKSB,TOKPB,TOKBU,TOKM2');
