...
define("LIST_STOCK_CATEGORIES_SETUP",              "('SETKL','SETBL')");
define("LIST_STOCK_CATEGORIES_TEST",               "('TESTSI','TESTSS','TESTFJ','TESTAC')");
define("LIST_STOCK_CATEGORIES_STABLE",             "('SILVER','STAINL','FASHIO','ACCESO')");
...
define("LIST_STOCK_CATEGORIES_SILVER",            "('TESTSI','SILVER','NOPOSI')");
define("LIST_STOCK_CATEGORIES_FASHION_JEWELLERY", "('TESTFJ','FASHIO','NOPOFJ')");
define("LIST_STOCK_CATEGORIES_STAINLESS",         "('TESTSS','STAINL','NOPOSS')");
define("LIST_STOCK_CATEGORIES_ACCESSORIES",       "('TESTAC','ACCESO','NOPOAC')");


/* Defines about LOCATIONS*/
define("LIST_KAPAL_LAUT_SHOPS",    "('TOK66','TOKSA','TOKKS','TOKJC','TOKSE','TOKUB','TOKMF','TOKPU','TOKSU','TOKBW','TOKOB','TOKSS','TOKPA','TOKKA')"); // NOT includes the shop online
define("LIST_OUTLET_SHOPS",        "('TOKSU','TOKJC')");
define("LIST_BLINK_SHOPS",         "('TOKMU')");
...
define("LIST_SHOPS_USING_PACKAGING_CONTROL", "('TOKPA','TOKSU','TOK66','TOKSA','TOKKS','TOKJC','TOKSE','TOKUB','TOKMF','TOKOB','TOKPU','TOKSS','TOKBW','TOKKA','PACKA')"); // PACKA MUST be the last one in this list
...
define("LIST_SHOPS_USING_KAPAL_LAUT_PACKAGING", "('TOK66','TOKSA','TOKKS','TOKSE','TOKUB','TOKMF','TOKOB','TOKPU','TOKSS','TOKBW','TOKPA','TOKKA')"); 
define("LIST_SHOPS_USING_OUTLET_PACKAGING",     "('TOKSU','TOKJC')"); 
define("LIST_SHOPS_USING_BLINK_PACKAGING",      "('TOKMU')"); 
...
define("CATEGORIES_AVAILABLE_WEBSITE", "('TESTSI','TESTSS','TESTFJ','TESTAC','SILVER','STAINL','FASHIO','ACCESO','NOPOSI','NOPOSS','NOPOFJ','NOPOAC','DISC20','DISC50','CONSIG')");
