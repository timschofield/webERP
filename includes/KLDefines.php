...
define("LIST_LOCATIONS_WITH_RL_ALWAYS_ZERO", "('KANTO','PACKA','WHSHE','SERVI','SERSU','SERDE','SAMPR','SASPG')");
...
define("PERCENTAGE_SALES_CASH_TO_PT", 11); // % of cash transactions going to cash KL acccounts
...
define("CATEGORIES_AVAILABLE_WEBSITE", "('TESTSI','TESTSS','TESTFJ','TESTAC','SILVER','STAINL','FASHIO','ACCESO','NOPOSI','NOPOSS','NOPOFJ','NOPOAC','DISCOU')");
