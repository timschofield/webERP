...
define("LIST_STOCK_CATEGORIES_SETUP",              "('SETKL', 'SETBL', 'SETGE', 'SETKLA','SETBLA','SETGEA')");
define("LIST_STOCK_CATEGORIES_TEST",               "('TESTKL','TESTBL','TESTGE','TESTKA','TESTBA','TESTGA')");
define("LIST_STOCK_CATEGORIES_STABLE",             "('STABKL','STABBL','STABGE','STABKA','STABBA','STABGA')");
define("LIST_STOCK_CATEGORIES_NO_MORE_PURCHASING", "('NOPOKL','NOPOBL','NOPOGE','NOPOKA','NOPOBA','NOPOGA')");
...
define("LIST_STOCK_CATEGORIES_KAPAL_LAUT", "('TESTKL','STABKL','NOPOKL','TESTKA','STABKA','NOPOKA')");
define("LIST_STOCK_CATEGORIES_BLINK",      "('TESTBL','STABBL','NOPOBL','TESTBA','STABBA','NOPOBA')");
define("LIST_STOCK_CATEGORIES_OUTLET",     "('DISC20','DISC50','DISC80','DISC2A','DISC5A','DISC8A')");
define("LIST_STOCK_CATEGORIES_GENERAL",    "('TESTGE','STABGE','NOPOGE','TESTGA','STABGA','NOPOGA')");
...
define("CATEGORIES_AVAILABLE_WEBSITE", "('TESTKL','TESTBL','TESTGE','STABKL','STABBL','STABGE','NOPOKL','NOPOBL','NOPOGE','DISC20','DISC50','TESTKA','TESTBA','TESTGA','STABKA','STABBA','STABGA','NOPOKA','NOPOBA','NOPOGA','DISC2A','DISC5A')");
