...
define("AVERAGE_INVOICE_VALUE_KL_01",  250000);
define("AVERAGE_INVOICE_VALUE_KL_02",  500000);
define("AVERAGE_INVOICE_VALUE_KL_03", 1000000);
define("AVERAGE_INVOICE_VALUE_KL_04", 1500000);
define("AVERAGE_INVOICE_VALUE_KL_05", 2000000);
define("AVERAGE_INVOICE_VALUE_KL_06", 2500000);
define("AVERAGE_INVOICE_VALUE_KL_07", 3000000);
define("AVERAGE_INVOICE_VALUE_KL_08", 4000000);

define("AVERAGE_INVOICE_VALUE_BLINK_01",  200000);
define("AVERAGE_INVOICE_VALUE_BLINK_02",  400000);
define("AVERAGE_INVOICE_VALUE_BLINK_03",  600000);
define("AVERAGE_INVOICE_VALUE_BLINK_04",  800000);
define("AVERAGE_INVOICE_VALUE_BLINK_05", 1000000);
define("AVERAGE_INVOICE_VALUE_BLINK_06", 1500000);
define("AVERAGE_INVOICE_VALUE_BLINK_07", 2000000);
define("AVERAGE_INVOICE_VALUE_BLINK_08", 2500000);
...
define("LIST_STOCK_CATEGORIES_IN_SHOPS_NOT_FOR_SALE", "('SHDISP', 'SHCONS', 'SHPACK', 'SHOTHE')");
...
define("LIST_STOCK_CATEGORIES_DISCOUNT_20", 	   "('DISC2A','DISC2B','DISC2G')");
define("LIST_STOCK_CATEGORIES_DISCOUNT_50",		   "('DISC5A','DISC5B','DISC5G')");
define("LIST_STOCK_CATEGORIES_DISCOUNT_80",        "('DISC8A','DISC8B','DISC8G')");
...
define("LIST_STOCK_CATEGORIES_KAPAL_LAUT_EXCLUDING_TEST",				"('STABKA','NOPOKA')");
define("LIST_STOCK_CATEGORIES_KAPAL_LAUT_INCLUDING_SETUP",				"('SETKLA','TESTKA','STABKA','NOPOKA')");
define("LIST_STOCK_CATEGORIES_KAPAL_LAUT_ONLY_DISCOUNT",				"('DISC2A','DISC5A','DISC8A')");
define("LIST_STOCK_CATEGORIES_KAPAL_LAUT_INCLUDING_DISC_20_50",			"('TESTKA','STABKA','NOPOKA','DISC2A','DISC5A')");
define("LIST_STOCK_CATEGORIES_KAPAL_LAUT_INCLUDING_ALL_DISCOUNT",		"('TESTKA','STABKA','NOPOKA','DISC2A','DISC5A','DISC8A')");
define("LIST_STOCK_CATEGORIES_KAPAL_LAUT_INCLUDING_SETUP_ALL_DISCOUNT",	"('SETKLA','TESTKA','STABKA','NOPOKA','DISC2A','DISC5A','DISC8A')");

define("LIST_STOCK_CATEGORIES_BLINK",								"('TESTBA','STABBA','NOPOBA')");
define("LIST_STOCK_CATEGORIES_BLINK_EXCLUDING_TEST",				"('STABBA','NOPOBA')");
define("LIST_STOCK_CATEGORIES_BLINK_INCLUDING_SETUP",				"('SETBLA','TESTBA','STABBA','NOPOBA')");
define("LIST_STOCK_CATEGORIES_BLINK_ONLY_DISCOUNT",					"('DISC2B','DISC5B','DISC8B')");
define("LIST_STOCK_CATEGORIES_BLINK_INCLUDING_DISC_20_50",			"('TESTBA','STABBA','NOPOBA','DISC2B','DISC5B')");
define("LIST_STOCK_CATEGORIES_BLINK_INCLUDING_ALL_DISCOUNT",		"('TESTBA','STABBA','NOPOBA','DISC2B','DISC5B','DISC8B')");
define("LIST_STOCK_CATEGORIES_BLINK_INCLUDING_SETUP_ALL_DISCOUNT",	"('SETBLA','TESTBA','STABBA','NOPOBA','DISC2B','DISC5B','DISC8B')");

define("LIST_STOCK_CATEGORIES_OUTLET",     "('DISC2A','DISC2B','DISC2G','DISC5A','DISC5B','DISC5G','DISC8A','DISC8B','DISC8G')");

define("LIST_STOCK_CATEGORIES_GENERAL",									"('TESTGA','STABGA','NOPOGA')");
define("LIST_STOCK_CATEGORIES_GENERAL_INCLUDING_SETUP",					"('SETGEA','TESTGA','STABGA','NOPOGA')");
define("LIST_STOCK_CATEGORIES_GENERAL_ONLY_DISCOUNT",					"('DISC2G','DISC5G','DISC8G')");
...
define("LIST_PHYSICAL_SHOPS_BY_TYPE", "('SHOPKL','SHOPBL','SHOPOU')");
define("LIST_ALL_SHOPS_BY_TYPE",  "('SHOPKL','SHOPBL','SHOPOU','ONLINE')");
define("LIST_GUDANG_PACKAGING_BY_TYPE", "('GUDPAC')"); 
define("LIST_ONLINE_SHOPS",       "('TOKWS')");

define("LIST_ITEMS_KAPAL_LAUT_PACKAGING", "('PKBX01-L','PKBX01-M','PKBX01-S','PKPB01-L','PKPB01-M','PKPB01-S','PKSB02-M','PKSB02-S','PKKS01-L1','PKKS01-L2','PKKS01-M','PKKS01-S')");
...
/* Defines about Pajak reports */ 
define("GL_CONSUMABLES", "('614011560AD','614011560BB','614011560SM')");
define("GL_ADJUSTMENT_STOCK", "('510500000AD','510500000BB','510500000SM')");
define("GL_COMMISSION_TOKOPEDIA", "('700211321AD','700211321BB','700211321SM')");
define("GL_COMMISSION_SHOPEE", "('700211322AD','700211322BB','700211322SM')");
define("GL_COMMISSION_PAYPAL", "('700211340AD','700211340BB','700211340SM')");
...
define("OPENCART_CUSTOMER_GROUP_GUEST", 0);
define("OPENCART_CUSTOMER_GROUP_RETAIL", 1);
define("OPENCART_CUSTOMER_GROUP_WHOLESALE_NO_MINIMUM", 4);
