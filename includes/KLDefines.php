...
define("LIST_STOCK_CATEGORIES_OUTLET",             "('DISC80')");
...
define("CATEGORIES_AVAILABLE_WEBSITE", "('TESTSI','TESTSS','TESTFJ','TESTAC','SILVER','STAINL','FASHIO','ACCESO','NOPOSI','NOPOSS','NOPOFJ','NOPOAC','DISC50','CONSIG')");
