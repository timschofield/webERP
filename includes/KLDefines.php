...
define("LIST_STOCK_CATEGORIES_KAPAL_LAUT", "('STABKL','NOPOKL','TESTKA','STABKA','NOPOKA')");
define("LIST_STOCK_CATEGORIES_BLINK",      "('STABBL','NOPOBL','TESTBA','STABBA','NOPOBA')");
define("LIST_STOCK_CATEGORIES_OUTLET",     "('DISC20','DISC50','DISC80','DISC2A','DISC5A','DISC8A')");
define("LIST_STOCK_CATEGORIES_GENERAL",    "('STABGE','NOPOGE','TESTGA','STABGA','NOPOGA')");
...
define("CATEGORIES_AVAILABLE_WEBSITE", "('STABKL','STABBL','STABGE','NOPOKL','NOPOBL','NOPOGE','DISC20','DISC50','TESTKA','TESTBA','TESTGA','STABKA','STABBA','STABGA','NOPOKA','NOPOBA','NOPOGA','DISC2A','DISC5A')");
