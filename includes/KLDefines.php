...
define("LIST_LOCATIONS_SPG_STOCK_STATUS", "('KANTO','TOK66','TOKSA','TOKKS','TOKSE','TOKOB','TOKPU','TOKSU','TOKSS','TOKPA','TOKKA','TOKMU','TOKPS','TOKAR','TOKSB','TOKPB','TOKBU','TOKM2','TOKU2','TOKU3','TOKO2','TOKBB','TOKTB')"); 
...
define("PERCENTAGE_COMPENSATION_HPP_PT", 190.0); // % of HPP to be assigned to PT sales. 100 means NO compensation.
...
define("LOCATIONS_WITH_STOCK_FOR_ONLINE_SHOP", 'KANTO,TOK66,TOKSA,TOKSS,TOKOB,TOKKS,TOKSE,TOKSU,TOKPU,TOKPA,TOKKA,TOKMU,TOKPS,TOKAR,TOKSB,TOKPB,TOKBU,TOKM2,TOKU2,TOKU3,TOKO2,TOKBB,TOKTB');
