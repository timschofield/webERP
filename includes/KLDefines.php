...
define("LIST_ALL_SHOPS",           "('TOK66','TOKSA','TOKKS','TOKSE','TOKUB','TOKMF','TOKPU','TOKSU','TOKOB','TOKSS','TOKPA','TOKKA','TOKMU','TOKPS','TOKAR','TOKSB','TOKPB','TOKBU','TOKM2','TOKU2','TOKU3','TOKO2','TOKBB','TOKTB')"); // NOT includes the shop online
...
define("LIST_LOCATIONS_SPG_STOCK_STATUS", "('KANTO','TOK66','TOKSA','TOKKS','TOKSE','TOKUB','TOKMF','TOKOB','TOKPU','TOKSU','TOKSS','TOKPA','TOKKA','TOKMU','TOKPS','TOKAR','TOKSB','TOKPB','TOKBU','TOKM2','TOKU2','TOKU3','TOKO2','TOKBB','TOKTB')"); 
...
define("LOCATIONS_WITH_STOCK_FOR_ONLINE_SHOP", 'KANTO,TOK66,TOKSA,TOKSS,TOKOB,TOKKS,TOKUB,TOKMF,TOKSE,TOKSU,TOKPU,TOKPA,TOKKA,TOKMU,TOKPS,TOKAR,TOKSB,TOKPB,TOKBU,TOKM2,TOKU2,TOKU3,TOKO2,TOKBB,TOKTB');
