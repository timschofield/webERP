...
define("LIST_STOCK_CATEGORIES_TEST",               "('TESTSI','TESTSS','TESTBL','TESTAC')");
...
define("LIST_STOCK_CATEGORIES_BLINK",      "('TESTBL','FASHIO','NOPOFJ')");
...
define("PERCENTAGE_SALES_CASH_TO_PT", 10); // % of cash transactions going to PT cash acccounts
...
define("CATEGORIES_AVAILABLE_WEBSITE", "('TESTSI','TESTSS','TESTBL','TESTAC','SILVER','STAINL','FASHIO','ACCESO','NOPOSI','NOPOSS','NOPOFJ','NOPOAC','DISC20','DISC50','CONSIG')");
...
define('STAINLESS_STEEL_BROOCHES',78);
...
define('FASHION_JEWELLERY_BROOCHES',77);
