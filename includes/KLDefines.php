...
define("LIST_ALL_SHOPS",           "('TOK66','TOKSA','TOKKS','TOKSE','TOKUB','TOKMF','TOKPU','TOKSU','TOKOB','TOKSS','TOKPA','TOKKA','TOKMU','TOKPS','TOKAR','TOKSB')"); // NOT includes the shop online
...
define("LIST_SHOPS_BLINK",         "('TOKMU','TOKPS','TOKSB')");

define("LIST_ONLINE_SHOPS", "('TOKWS')");

define("LIST_GUDANG_FOR_PACKAGING","('PACKA')");

define("LIST_LOCATIONS_SPG_STOCK_STATUS",	 "('KANTO','TOK66','TOKSA','TOKKS','TOKSE','TOKUB','TOKMF','TOKOB','TOKPU','TOKSU','TOKSS','TOKPA','TOKKA','TOKMU','TOKPS','TOKAR','TOKSB')"); 
...
define("LOCATIONS_WITH_STOCK_FOR_ONLINE_SHOP", 'KANTO,TOK66,TOKSA,TOKSS,TOKOB,TOKKS,TOKUB,TOKMF,TOKSE,TOKSU,TOKPU,TOKPA,TOKKA,TOKMU,TOKPS,TOKAR,TOKSB');
