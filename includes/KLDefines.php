...
define("LIST_STOCK_CATEGORIES_KAPAL_LAUT_INCLUDING_DISCOUNT", "('TESTKA','STABKA','NOPOKA','DISC2A','DISC5A','DISC8A')");
define("LIST_STOCK_CATEGORIES_BLINK_INCLUDING_DISCOUNT", 	  "('TESTBA','STABBA','NOPOBA','DISC2B','DISC5B','DISC8B')");
