...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++>>
		...
		$SelectNetProfit = "Sum(CASE WHEN (chartdetails.period >= '" . $_POST['PeriodFrom'] . "' AND chartdetails.period <= '" . int($_POST['PeriodTo'] . "') THEN -chartdetails.budget ELSE 0 END) AS BudgetProfit,";// ShowBudget=ON vs. ShowBudget=OFF.*/
		$Sql = "SELECT
