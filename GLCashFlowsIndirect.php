...
//<<----------------------------------------------------------------------------
	...
	echo			'</select>',
					'<span class="field_help_text">',
						_('Select the beginning of the reporting period'), // If the parameter $_SESSION['ShowFieldHelp'] parameter OR it is TRUE, shows the page help text.
					'</span>',
		 		'</td>
			</tr>',
			// Select period to:
	...
	echo			'</select>',
					'<span class="field_help_text">',
						_('Select the end of the reporting period'), // If the parameter $_SESSION['ShowFieldHelp'] parameter OR it is TRUE, shows the page help text.
					'</span>',
		 		'</td>
			</tr>';
	...
	echo '<tr>',
			 	...
			 	<td><input',($_POST['ShowBudget'] ? ' checked="checked"' : ''), ' id="ShowBudget" name="ShowBudget" type="checkbox">', // "Checked" if ShowBudget is set AND it is TRUE.
			 		'<span class="field_help_text">',
			 			_('Check this box to show the budget for the period'), // If the parameter $_SESSION['ShowFieldHelp'] parameter OR it is TRUE, shows the page help text.
					'</span>',
		 		'</td>
			</tr>',
			...
			'<tr>',
				'<td><label for="ShowZeroBalance">', _('Show accounts with zero balance'), '</label></td>
			 	<td><input',(isset($_POST['ShowZeroBalance']) && $_POST['ShowZeroBalance'] ? ' checked="checked"' : ''), ' id="ShowZeroBalance" name="ShowZeroBalance" type="checkbox">', // "Checked" if ShowZeroBalance is set AND it is TRUE.
					'<span class="field_help_text">',
						_('Check this box to show all accounts including those with zero balance'), // If the parameter $_SESSION['ShowFieldHelp'] parameter OR it is TRUE, shows the page help text.
					'</span>',
		 		'</td>
			</tr>',
			...
			'<tr>',
			 	...
			 	<td><input',($_POST['ShowCash'] ? ' checked="checked"' : ''), ' id="ShowCash" name="ShowCash" type="checkbox">', // "Checked" if ShowZeroBalance is set AND it is TRUE.
					'<span class="field_help_text">',
						_('Check this box to show cash and cash equivalents accounts'), // If the parameter $_SESSION['ShowFieldHelp'] parameter OR it is TRUE, shows the page help text.
					'</span>',
		 		'</td>
			</tr>',
		 '</tbody></table>';
