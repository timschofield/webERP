...
/******************************************************************************************************************
*
* KL RICARD Remove Report Links
*			Check that AND ($Caption != '') to avoid empty lines on the menu
*
*******************************************************************************************************************/
...
if (isset($MenuItems[$_SESSION['Module']]['Reports'])) {
	foreach ($MenuItems[$_SESSION['Module']]['Reports']['Caption'] as $Caption) {
		...
		$PageSecurity = $_SESSION['PageSecurityArray'][$ScriptNameArray[0]];
// KL RICARD Check that AND ($Caption != '') to avoid empty lines on the menu
		if ((in_array($PageSecurity, $_SESSION['AllowedPageSecurityTokens']) or !isset($PageSecurity)) AND ($Caption != '')) {
// KL RICARD END
			echo '<li class="MenuItem">
...
// KL RICARD Comment the Report Links
