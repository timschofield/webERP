...
echo '<field>
		<label for="Volume">' . _('Packaged Volume (m3)') . ':</label>
		...
		<fieldhelp>' . _('Volume of the shipping box containing the item in m3.') . '</fieldhelp>
	</field>';
...
echo '<field>
		...
		<fieldhelp>' . _('Weight of the item + shipping box in KG.') . '</fieldhelp>
	</field>';
