...
if (isset($OrderNumber)) {
	...
	echo __('OC/Marketplace/Other Ref') . ' - ' . $CustomerRef;
	if (mb_strlen($_SESSION['UserBranch'])>1){
...
} elseif ((isset($_POST['SearchOrders']) and Is_Date($_POST['OrdersAfterDate']) == 1) or (isset($CustomerGet))) {
...
echo '<field>
		<label for = "CustomerRef">' . __('Other Ref') . ':</label>
