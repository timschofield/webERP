...
$Title = _('Profit and Loss for Kapal-Laut');
...
// Print heading if at end of page
	...
	while ($myrow=DB_fetch_array($AccountsResult)) {
		...
		if ($_POST['Detail']=='Detailed'){
			...
			$ActEnquiryURL = '<a href="' . $RootPath . '/KLGLAccountInquiryM.php?Period=' . $_POST['ToPeriod'] . '&Account=' . $myrow['accountcode'] . '&Show=Yes">' . $myrow['accountcode'] . '</a>';
