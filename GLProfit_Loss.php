...
if (isset($_POST['PrintPDF']) or isset($_POST['View'])) {
	...
	$HTML .= '<table summary="' . _('General Ledger Profit Loss Inquiry') . ' ' . _('From') . ' ' . $PeriodFromDate . ' ' . _('to') . ' ' . $PeriodToDate . '">
			<thead>
				<tr>
					<th colspan="8">
						<b>' . _('General Ledger Profit Loss Inquiry') . ' ' . _('From') . ' ' . $PeriodFromDate . ' ' . _('to') . ' ' . $PeriodToDate . '</b>
					</th>
				</tr>';
