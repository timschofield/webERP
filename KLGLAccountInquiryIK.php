...
$Title = _('General Ledger Account Inquiry for POIK');
...
$SQL = "SELECT chartmasterIK.accountcode,
			bankaccounts.accountcode AS bankact,
			bankaccounts.currcode,
			chartmasterIK.accountname
		FROM chartmasterIK LEFT JOIN bankaccounts
		ON chartmasterIK.accountcode=bankaccounts.accountcode
...
if (isset($_POST['Show'])) {
	...
	$Result = DB_query("SELECT pandl
				FROM accountgroups
				INNER JOIN chartmasterIK ON accountgroups.groupname=chartmasterIK.group_
				WHERE chartmasterIK.accountcode='" . $SelectedAccount . "'");
	...
	$NameSQL = "SELECT accountname FROM chartmasterIK WHERE accountcode='" . $SelectedAccount . "'";
