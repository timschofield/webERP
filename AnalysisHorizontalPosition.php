...
if (!isset($_POST['PeriodTo']) or isset($_POST['NewReport'])) {
	...
	echo '<div id="Report">', // Division to identify the report block.
		...
		__('All amounts stated in'), ': ', _($CurrencyName[$_SESSION['CompanyRecord']['currencydefault']]), '</p>';// Page title, reporting presentation currency and level of rounding used.
